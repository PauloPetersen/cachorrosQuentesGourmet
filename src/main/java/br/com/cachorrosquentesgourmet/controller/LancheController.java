...
public class LancheController {
    ...
    @GetMapping
    public ResponseEntity<List<Lanche>> obterTodos() {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Lanche> atualizarLanche(@PathVariable Long id, @RequestBody Lanche lancheAtualizado) {
        Lanche lancheAtualizadoResult = lancheService.atualizar(id, lancheAtualizado);
        return new ResponseEntity<>(lancheAtualizadoResult, HttpStatus.OK);
    }
